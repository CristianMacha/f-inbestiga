...
export const loadRequirements = createAction('[Project Component] Load Requirement', props<{ projectId: number }>());
export const requirementLoadedSuccess = createAction('[Project Component] Requirement Loaded Success', props<{ requirements: Requirement[] }>());
export const activeFormR = createAction('[Project Component] Active FormR', props<{ active: boolean }>());
export const activeFormRUpdate = createAction('[Project Component] Active FormR Update', props<{ requirement: Requirement }>());
